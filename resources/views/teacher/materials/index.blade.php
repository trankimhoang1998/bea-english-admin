                                ...
                                <td class="px-lg py-md text-right">
                                    @if($material->material_link)
                                        <a href="{{ $material->material_link }}" target="_blank" rel="noopener"
                                           class="inline-flex items-center gap-xs whitespace-nowrap bg-sky-100 text-sky-700 font-label-sm px-sm py-xs rounded-lg hover:bg-sky-200 transition-all active:scale-95">
