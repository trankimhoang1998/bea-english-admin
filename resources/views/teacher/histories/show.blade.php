<x-app-layout>
    <x-slot name="title">Teaching Record | BEA English</x-slot>
    <x-slot name="header">
                ...
                <div class="px-lg py-md grid grid-cols-1 sm:grid-cols-3 gap-md">
                    ...
                    <dd class="col-span-2">
                        <x-video-player
                            ...
                            :stream-url="route('teacher.histories.stream', $history)"
                            :download-url="route('teacher.histories.video', $history)"
                        />
                    </dd>
                </div>
            </dl>
