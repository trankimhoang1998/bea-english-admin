<x-app-layout>
    <x-slot name="title">Add Student | BEA English</x-slot>
    <x-slot name="header">
        <div class="flex items-center gap-md">
            ...
            <div>
                <h1 class="font-bold text-headline-sm text-on-surface">Add Student</h1>
                <p class="text-label-sm text-secondary mt-xs">Enroll a new student</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl">
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-sm p-lg">
            <form method="POST" action="{{ route('manager.students.store') }}" class="space-y-lg">
                @csrf
