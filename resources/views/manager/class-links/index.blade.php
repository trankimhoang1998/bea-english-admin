                                ...
                                <td class="px-lg py-md">
                                    ...
                                    <div x-show="!editing" class="flex items-center gap-xs">
                                        ...
                                        <a href="{{ $cl->link }}" target="_blank" rel="noopener"
                                           class="text-body-sm text-primary hover:underline truncate max-w-xs">{{ $cl->link }}</a>
                                    </div>
                                    {{-- Edit form --}}
                                    <form x-show="editing" x-cloak method="POST"
                                        ...
                                        <div class="flex items-center gap-sm">
                                            <input type="url" name="link" value="{{ $cl->link }}"
                                ...
                                <td class="px-lg py-md">
                                    <div class="flex items-center justify-end gap-sm">
                                        ...
                                        <button type="button" x-show="!editing"
                                                @click="$store.confirmModal.show('Delete class link for {{ addslashes($cl->student->user->name) }}?', 'del-cl-{{ $cl->id }}')"
