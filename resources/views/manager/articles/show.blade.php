    ...
    <x-slot name="header">
        <div class="flex items-center justify-between gap-sm">
            ...
            <a href="{{ route('manager.articles.edit', $article) }}"
               class="inline-flex items-center gap-sm bg-primary-container text-on-primary font-label-md px-md py-sm rounded-lg hover:brightness-110 transition-all active:scale-95 shrink-0">
