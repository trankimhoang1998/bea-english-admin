...
<section id="about" class="py-8 lg:py-24 bg-surface-alt">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">

        {{-- Title pill --}}
        <div class="flex items-center justify-center gap-3 mb-6 lg:mb-10 reveal">
        ...
        <div class="grid sm:grid-cols-2 gap-3 mb-4">
            ...
            <div class="flex items-start gap-2.5 sm:gap-3 bg-white rounded-2xl px-3.5 sm:px-6 py-3.5 sm:py-5 shadow-sm border border-gray-100 reveal">
                <div class="shrink-0 w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-primary-container flex items-center justify-center shadow-md shadow-primary-container/25">
                    <span class="material-symbols-outlined ms-filled text-white text-[16px] sm:text-[20px]">{{ $icon }}</span>
                </div>
                <p class="text-[13px] sm:text-[14px] text-gray-600 leading-relaxed pt-1">
        ...
        {{-- Callout --}}
        <div class="flex items-start gap-2.5 sm:gap-3 bg-gray-100 rounded-2xl px-3.5 sm:px-6 py-3.5 sm:py-5 mb-5 lg:mb-8 border-l-4 border-primary-container reveal">
            <span class="material-symbols-outlined ms-filled text-primary-container text-[20px] sm:text-[24px] shrink-0 mt-0.5">chevron_right</span>
            <p class="text-[13.5px] sm:text-[15px] text-gray-700 leading-relaxed">
        ...
        {{-- Gift cards --}}
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 mb-5 lg:mb-7">
            @foreach([
            ...
            <div class="bg-primary-container rounded-2xl px-4 sm:px-6 py-3.5 sm:py-7
                        sm:flex-col flex items-center sm:items-start gap-3 sm:gap-0
                ...
                <p class="text-white font-black text-[1.15rem] sm:text-[1.7rem] leading-none ml-auto sm:ml-0">{{ $price }}</p>
            </div>
            @endforeach
        </div>
