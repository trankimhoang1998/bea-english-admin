        ...
        <div class="{{ $revealDelay }} mb-8 last:mb-0">
            ...
            <div class="grid grid-cols-2 gap-3 lg:hidden">
                ...
                <div class="lt-card group flex flex-col items-center bg-white border border-gray-200 rounded-2xl px-3 py-5 cursor-pointer relative"
                    ...
                    <div class="w-16 h-16 rounded-full bg-gradient-to-br {{ $item['grad'] }} flex flex-col items-center justify-center mb-3 shadow-md shadow-orange-400/25 group-hover:scale-110 transition-transform duration-300">
