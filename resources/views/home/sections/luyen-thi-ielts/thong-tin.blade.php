...
<section class="relative overflow-hidden bg-surface-alt py-12 lg:py-16">
    ...
    <div class="relative max-w-7xl mx-auto px-5 lg:px-16">
        ...
        <div class="text-center mb-8 reveal">
            <div class="inline-flex items-center gap-2">
                ...
                <h2 class="text-on-background font-black text-lg uppercase tracking-wide">Thông tin khóa học</h2>
            </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 reveal">
            @foreach($stats as $i => [$icon, $label, $value, $grad])
            <div class="bg-white border border-gray-200 rounded-2xl px-6 py-5 flex flex-col gap-3 shadow-sm hover:shadow-md hover:border-orange-200 transition-all duration-300">
                ...
                <span class="text-on-background font-black text-[18px] lg:text-[20px]">{{ $value }}</span>
            </div>
            @endforeach
        </div>
