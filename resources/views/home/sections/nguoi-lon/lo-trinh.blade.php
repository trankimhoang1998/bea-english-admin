{{-- resources/views/home/sections/nguoi-lon/lo-trinh.blade.php --}}
            ...
            [
                ...
                'items'   => [
                    [
                        ...
                        'audience' => 'Phù hợp với người mới bắt đầu, chỉ mới tiếp xúc và có những kiến thức cơ bản nhất về tiếng Anh',
                        ...
                        'goals'    => [
                            'Làm quen với bảng chữ cái và phát âm tiếng Anh cơ bản',
                            'Học từ vựng thiết yếu trong cuộc sống hàng ngày',
                            'Nắm vững các cấu trúc câu đơn giản',
                            'Có thể giao tiếp cơ bản về bản thân và gia đình',
                            'Xây dựng nền tảng vững chắc cho việc học tiếng Anh',
                        ],
                        'skills'   => ['Nghe hiểu từ đơn giản', 'Nói cơ bản về bản thân', 'Đọc hiểu câu đơn giản', 'Viết từ và câu cơ bản'],
                    ],
                    [
                        'cefr'     => 'A1',
                        'en'       => 'Beginner',
                        ...
                        'audience' => 'Phù hợp với người đang có trình độ tiếng anh tương đương A1–',
                        ...
                        'goals'    => [
                            'Mở rộng vốn từ vựng về cuộc sống hàng ngày',
                            'Sử dụng các thì cơ bản trong giao tiếp',
                            'Miêu tả người và sự vật xung quanh',
                            'Thảo luận về hoạt động thường nhật',
                            'Giao tiếp cơ bản trong các tình huống thực tế',
                        ],
                        'skills'   => ['Nghe hiểu hội thoại ngắn', 'Nói về hoạt động hàng ngày', 'Đọc văn bản đơn giản', 'Viết đoạn văn ngắn'],
                    ],
                    [
                        'cefr'     => 'A1+',
                        'en'       => 'Upper-Beginner',
                        ...
                        'goals'    => [
                            'Sử dụng từ vựng so sánh và miêu tả',
                            'Nắm vững thì quá khứ đơn cơ bản',
                            'Kể lại sự việc đã xảy ra',
                            'Đưa ra chỉ dẫn đơn giản',
                            'Mô tả ngoại hình và tính cách người khác',
                        ],
                        'skills'   => ['Nghe hiểu chi tiết hơn', 'Nói về quá khứ', 'Đọc hiểu chính xác', 'Viết mô tả đơn giản'],
                    ],
                    [
                        'cefr'     => 'A2',
                        'en'       => 'Elementary',
                        ...
                        'goals'    => [
                            'Thảo luận về các sự việc thời sự',
                            'Kể lại trải nghiệm trong quá khứ',
                            'Đưa ra lời khuyên về sức khỏe',
                            'So sánh lối sống các quốc gia',
                            'Thảo luận về môi trường và thiên nhiên',
                        ],
                        'skills'   => ['Nghe hiểu tin tức đơn giản', 'Nói về nhiều chủ đề', 'Đọc bài báo ngắn', 'Viết email cá nhân'],
                    ],
                    [
                        'cefr'     => 'A2+',
                        'en'       => 'Upper-Elementary',
                        ...
                        'audience' => 'Phù hợp với người đang có trình độ tiếng anh tương đương A2',
                        ...
                        'goals'    => [
                            'Miêu tả người và tính cách chi tiết',
                            'Thảo luận về bảo vệ môi trường',
                            'Nói về kế hoạch tương lai',
                            'Sử dụng thành thạo so sánh nhất',
                            'Kể về khả năng trong quá khứ',
                        ],
                ...
                'items'   => [
                    [
                        ...
                        'goals'    => [
                            ...
                            'Thảo luận về vấn đề toàn cầu',
                            'Kể về sự kiện lịch sử quan trọng',
                            'Nói về đóng góp cộng đồng',
                    ...
                    [
                        ...
                        'audience' => 'Phù hợp với người đang có trình độ tiếng anh tương đương B1–',
                        ...
                        'goals'    => [
                            ...
                            'Viết email và thư tín chuyên nghiệp',
                            'Đọc hiểu tin tức và báo chí',
                    ...
                    [
                        ...
                        'goals'    => [
                            'Trình bày quan điểm có lý lẽ',
                            'Viết bài luận có cấu trúc',
                            'Thảo luận về vấn đề xã hội',
                            'Nghe hiểu trong môi trường công sở',
                    ...
                    [
                        ...
                        'goals'    => [
                            'Thảo luận chuyên sâu với từ vựng học thuật',
                    ...
                    [
                        ...
                        'audience' => 'Phù hợp với người đang có trình độ tiếng anh tương đương B2–',
            ...
            <div class="hidden lg:block pt-3 pb-1">
                <div class="flex items-center justify-center gap-2">
                    ...
                    <div class="lt-card group flex flex-col items-center bg-white border border-gray-200 rounded-2xl px-6 py-8 w-[200px] cursor-pointer"
                         ...
                         @click="openModal = '{{ $item['cefr'] }}'">
                        <div class="w-28 h-28 rounded-full bg-gradient-to-br {{ $item['grad'] }} flex items-center justify-center mb-5 shadow-xl shadow-orange-400/30 group-hover:scale-110 transition-transform duration-300">
                            <span class="text-white font-black text-[22px] leading-none">{{ $item['cefr'] }}</span>
                        </div>
