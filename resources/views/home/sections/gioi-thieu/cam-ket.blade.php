...
<section class="relative overflow-hidden bg-surface-alt py-20 lg:py-28">
    ...
    <div class="relative max-w-7xl mx-auto px-5 lg:px-16">
        ...
        <div class="text-center mb-14 reveal">
            ...
            <p class="text-gray-800 font-semibold text-lg">Chúng tôi không chỉ dạy <span class="text-orange-500">&mdash;</span> chúng tôi cam kết kết quả</p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="ck-card reveal group bg-white rounded-3xl overflow-hidden border border-gray-200 flex flex-col">
                ...
                <div class="p-7 lg:p-8 flex-1 flex flex-col">
                    ...
                    <div class="flex items-start justify-between mb-6">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined ms-filled text-white text-[26px]">workspace_premium</span>
                        </div>
                        <span class="text-[3.5rem] font-black leading-none text-gray-900/[0.05] select-none">01</span>
                    </div>
                    {{-- Title --}}
                    <h3 class="text-on-background font-black text-[16px] lg:text-[17px] leading-snug mb-4">
                        Cam kết hiệu quả, cá nhân hóa 100%
                    </h3>
                    {{-- Body --}}
                    <p class="text-gray-500 text-[13.5px] leading-relaxed flex-1">
            ...
            <div class="ck-card reveal reveal-delay-1 group bg-white rounded-3xl overflow-hidden border border-gray-200 flex flex-col">
                ...
                <div class="p-7 lg:p-8 flex-1 flex flex-col">
                    <div class="flex items-start justify-between mb-6">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined ms-filled text-white text-[26px]">school</span>
                        </div>
                        <span class="text-[3.5rem] font-black leading-none text-gray-900/[0.05] select-none">02</span>
                    </div>
                    <h3 class="text-on-background font-black text-[16px] lg:text-[17px] leading-snug mb-4">
            ...
            <div class="ck-card reveal reveal-delay-2 group bg-white rounded-3xl overflow-hidden border border-gray-200 flex flex-col">
                ...
                <div class="p-7 lg:p-8 flex-1 flex flex-col">
                    <div class="flex items-start justify-between mb-6">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined ms-filled text-white text-[26px]">payments</span>
                        </div>
                        <span class="text-[3.5rem] font-black leading-none text-gray-900/[0.05] select-none">03</span>
                    </div>
                    <h3 class="text-on-background font-black text-[16px] lg:text-[17px] leading-snug mb-4">
                        Chi phí hợp lý, lịch học linh hoạt
                    </h3>
                    <p class="text-gray-500 text-[13.5px] leading-relaxed mb-5">
