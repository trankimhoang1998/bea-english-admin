...
<section class="relative overflow-hidden bg-white py-10 lg:py-28">
    ...
    <div class="relative max-w-7xl mx-auto px-5 lg:px-16">
        ...
        {{-- Header --}}
        <div class="text-center mb-6 lg:mb-16 reveal">
            <div class="inline-flex items-center gap-3 mb-5">
                ...
                <div class="bg-primary-container rounded-full px-4 py-2 lg:px-8 lg:py-3">
                    <h2 class="lg:hidden text-white font-black text-base uppercase tracking-wide">Phương Châm Đào Tạo</h2>
                    <h2 class="hidden lg:block text-white font-black text-2xl uppercase tracking-wide">Giữ Vững Phương Châm Đào Tạo</h2>
                </div>
                <div class="h-[2px] w-6 lg:w-10 bg-primary-container rounded-full"></div>
            </div>
            <p class="hidden lg:block text-gray-800 font-semibold text-lg">Nguyên tắc vàng <span class="text-orange-500">&mdash;</span> định hướng mọi buổi học tại BeA English</p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-4">
            ...
            <div class="pc-row reveal {{ $delay }} group flex items-center gap-3 lg:gap-5 bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 lg:px-6 lg:py-5">

                {{-- Icon --}}
                <div class="shrink-0 w-11 h-11 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br {{ $grad }} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <span class="material-symbols-outlined ms-filled text-white text-[18px] lg:text-[24px]">{{ $icon }}</span>
                </div>
                ...
                {{-- Arrow --}}
                <div class="hidden lg:flex shrink-0 w-8 h-8 rounded-full bg-gray-100 items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1">
