...
<section class="relative overflow-hidden bg-white py-10 lg:py-28">
    ...
    <div class="relative max-w-7xl mx-auto px-5 lg:px-16">
        ...
        <div class="text-center mb-6 lg:mb-14 reveal">
            ...
            <h2 class="hidden lg:block text-on-background font-black text-2xl lg:text-[2.2rem] uppercase leading-tight">
                Tầm Nhìn &amp; Sứ Mệnh
            </h2>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-4 lg:gap-8">
            ...
            <div class="relative rounded-3xl overflow-hidden border border-gray-200 reveal tnsm-card group">
                ...
                {{-- Big bg number --}}
                <div class="absolute -bottom-4 -right-2 text-[6rem] lg:text-[10rem] font-black leading-none pointer-events-none select-none text-gray-900/[0.04] group-hover:text-gray-900/[0.07] transition-colors duration-500">01</div>
                ...
                <div class="p-5 lg:p-10">
                    ...
                    <div class="flex items-center gap-3 lg:gap-4 mb-4 lg:mb-7">
                        <div class="w-11 h-11 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shrink-0 shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined ms-filled text-white text-[20px] lg:text-[26px]">visibility</span>
                        </div>
                        <div>
                            <p class="text-primary-container text-[11px] font-bold uppercase tracking-[0.2em] mb-0.5">01</p>
                            <h3 class="text-on-background font-black text-base lg:text-2xl uppercase tracking-wide">Tầm Nhìn</h3>
                        </div>
                    </div>

                    {{-- Content --}}
                    <p class="text-gray-600 text-[13.5px] lg:text-[14.5px] leading-relaxed mb-4 lg:mb-7">
                    ...
                    {{-- Stat highlight --}}
                    <div class="inline-flex items-center gap-2.5 lg:gap-3 bg-primary-container/10 border border-primary-container/20 rounded-2xl px-4 py-2.5 lg:px-5 lg:py-3.5">
                        <span class="material-symbols-outlined ms-filled text-primary-container text-[18px] lg:text-[22px]">groups</span>
                        <div>
                            <div class="text-primary-container font-black text-lg lg:text-2xl leading-none">1 TRIỆU</div>
            ...
            <div class="relative rounded-3xl overflow-hidden border border-gray-200 reveal reveal-delay-1 tnsm-card group">
                ...
                {{-- Big bg number --}}
                <div class="absolute -bottom-4 -right-2 text-[6rem] lg:text-[10rem] font-black leading-none pointer-events-none select-none text-gray-900/[0.04] group-hover:text-gray-900/[0.07] transition-colors duration-500">02</div>
                ...
                <div class="p-5 lg:p-10">
                    {{-- Icon + title --}}
                    <div class="flex items-center gap-3 lg:gap-4 mb-4 lg:mb-7">
                        <div class="w-11 h-11 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center shrink-0 shadow-lg shadow-orange-500/25 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined ms-filled text-white text-[20px] lg:text-[26px]">rocket_launch</span>
                        </div>
                        <div>
                            <p class="text-primary-container text-[11px] font-bold uppercase tracking-[0.2em] mb-0.5">02</p>
                            <h3 class="text-on-background font-black text-base lg:text-2xl uppercase tracking-wide">Sứ Mệnh</h3>
                        </div>
                    </div>
                    ...
                    {{-- Value tags --}}
                    <div class="flex flex-wrap gap-2 max-h-[4.5rem] overflow-hidden lg:max-h-none lg:overflow-visible">
