    ...
    <div class="relative max-w-7xl mx-auto px-5 lg:px-16">
        ...
        <div class="text-center mb-14 reveal">
            <div class="inline-flex items-center gap-3 mb-5">
                ...
                <div class="bg-primary-container rounded-full px-8 py-3">
                    <h2 class="text-white font-black text-xl lg:text-2xl uppercase tracking-wide">Chính Sách Và Cam Kết</h2>
                </div>
                <div class="h-[2px] w-10 bg-primary-container rounded-full"></div>
            </div>
            <p class="text-gray-800 font-semibold text-lg">Minh bạch – Rõ ràng – Có trách nhiệm <span class="text-orange-500">&mdash;</span> BeA English cam kết bằng hợp đồng</p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="cs-card reveal group bg-white rounded-3xl overflow-hidden border border-gray-200 flex flex-col">
                ...
                <div class="p-8 lg:p-10 flex-1">
                    <div class="flex items-center gap-3 mb-7">
                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/20 group-hover:scale-110 transition-transform duration-300 shrink-0">
                            <span class="material-symbols-outlined ms-filled text-white text-[22px]">policy</span>
                        </div>
                        <h3 class="text-on-background font-black text-xl">Chính sách</h3>
                    </div>
                    @php
                    $policies = [
            ...
            <div class="cs-card reveal reveal-delay-1 group bg-white rounded-3xl overflow-hidden border border-gray-200 flex flex-col">
                ...
                <div class="p-8 lg:p-10 flex-1">
                    <div class="flex items-center gap-3 mb-7">
                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-lg shadow-orange-500/20 group-hover:scale-110 transition-transform duration-300 shrink-0">
                            <span class="material-symbols-outlined ms-filled text-white text-[22px]">workspace_premium</span>
                        </div>
                        <h3 class="text-on-background font-black text-xl">Cam kết</h3>
                    </div>
                    @php
                    $commitments = [
