<x-app-layout>
    ...
    <x-slot name="header">
        <div>
            ...
            <p class="text-label-sm text-secondary mt-xs">View all teacher–student class links</p>
        </div>
    </x-slot>
    ...
    <form method="GET" action="{{ route('vice-manager.class-links.index') }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-md items-end">
            ...
            <div class="space-y-xs"
                 x-data="{
                     search: window._vmClassLinkFilters.teacherInit,
                     value: window._vmClassLinkFilters.teacherValue,
                     open: false,
                     options: window._vmClassLinkFilters.teacherOptions,
                     get filtered() {
            ...
            <div class="flex gap-sm items-end col-span-1 sm:col-span-2">
                ...
                @if(request()->anyFilled(['teacher_id']))
                    <a href="{{ route('vice-manager.class-links.index') }}"
