            ...
            <div class="p-md border-b border-outline-variant bg-surface-container-low/50 space-y-md">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-md">
                    ...
                    <div class="space-y-xs">
                        ...
                        <input type="date" x-model="ft" class="w-full border border-outline-variant rounded-lg px-md py-sm text-body-sm text-on-surface bg-surface-container-lowest focus:border-primary outline-none transition-all">
                    </div>
                    <div class="space-y-xs">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-md items-end">
                    <div class="space-y-xs">
                        ...
                        <select x-model="fs" class="w-full border border-outline-variant rounded-lg px-md py-sm text-body-sm text-on-surface bg-surface-container-lowest focus:border-primary outline-none transition-all">
                    ...
                    <div class="flex items-end">
                        <button type="button" @click="fs=''; fd=''; ft=''; fdu=''; ftf=''; ftt=''"
                                x-show="fs || fd || ft || fdu || ftf || ftt" x-cloak
